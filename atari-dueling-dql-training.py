from agents import DuelingDeepQAgent
...
weights_file = f'checkpoints/{game_name}-dueling_dqn.pt'
n_games = 300
batch_size = 32
...
plot_filename = f'plots/{game_name}-dueling_dql.png'
...
agent = DuelingDeepQAgent(epsilon, epsilon_decay, epsilon_min, gamma, state_space_dims, action_space_dims, DQN, target_DQN, update_target_net, batch_size, max_memory_size)
